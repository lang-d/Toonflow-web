          ...
          <div class="previewTabBody">
            ...
            <div class="previewGridPanel">
              <div class="previewGrid" :style="previewGridStyle">
                <div v-for="item in currentPreviewItems" :key="item.id" class="previewGridItem" @click="emit('openImageViewer', item)">
                  <img
                    :src="getStoryboardImageUrl(item, 'preview')"
                    :style="{ objectFit: getPreviewImageFit(item) }"
                    loading="eager"
                    @load="emit('imageLoad', getStoryboardImageUrl(item, 'preview'), $event)" />
          ...
          <div class="previewTabBody">
            <div class="timelinePlayer">
              <div class="timelineMainStage">
                ...
                <div v-if="timelineCurrent" class="timelineHero" @click="emit('openImageViewer', timelineCurrent)">
                  <img v-if="getStoryboardImageUrl(timelineCurrent, 'preview')" :src="getStoryboardImageUrl(timelineCurrent, 'preview')" />
                </div>
              ...
              <div class="timelineStrip">
                <div
                  ...
                  <img :src="getStoryboardImageUrl(item, 'display') || getStoryboardImageUrl(item, 'preview')" loading="lazy" />
                  <div>
