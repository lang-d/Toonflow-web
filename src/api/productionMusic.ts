...
export interface MusicModelCapabilities { durationRange?: { min?: number; max?: number }; vocal?: boolean | "optional"; lyrics?: boolean | "optional"; referenceAudio?: boolean | "optional"; loop?: boolean | "optional"; outputFormats?: string[]; }
...
export interface MusicCueAsset { id: number; cueId: number; version?: number; state?: string; errorReason?: string | null; selected?: boolean | number; assetsId?: number | null; childAssetId?: number | null; media?: unknown; src?: string | null; url?: string | null; audioUrl?: string | null; [key: string]: unknown; }
...
export const compileMusicCuePrompt = (params: { projectId: number; cueId: number; model: string; instruction?: string }) => task("/production/music/cue/compilePrompt", params);
...
export const generateMusicCueAudio = (params: { projectId: number; cueId: number; promptVersionId: number; acknowledgeWarnings?: boolean; select?: boolean }) => task("/production/music/cue/generate", params);
...
export const compileMusicLibraryPrompt = (params: { projectId: number; editionId: number; model: string; instruction?: string; effectiveMusicDurationSec?: number; requestedDurationSec?: number; lyricsVersionId?: number | null }) => task("/production/music/library/compilePrompt", params);
...
export const generateMusicLibraryAudio = (params: { projectId: number; editionId: number; promptVersionId: number; lyricsVersionId?: number | null; acknowledgeWarnings?: boolean }) => task("/production/music/library/generate", params);
